...
export const POST_SLUG_REQUEST = 'POST_SLUG_REQUEST'
export const POST_SLUG_SUCCESS = 'POST_SLUG_SUCCESS'
export const POST_SLUG_FAIL = 'POST_SLUG_FAIL'
export const POST_SLUG_RESET = 'POST_SLUG_RESET'
